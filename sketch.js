...
function diagram3(diameter, diagramPendidikan) {
  ...
  textFont(f2)
  text("Tidak Sekolah/Tidak Tamat  = 37",10,3320)
  text("Sekolah Dasar/Sederajat  = 2281",10,3345)
  text("Sekolah Menengah Pertama/Sederajat  = 1963",10,3370)
  text("Sekolah Menengah Atas/Sederajat  = 455",10,3395)
